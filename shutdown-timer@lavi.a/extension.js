/*
 *	Shutdown Timer Extension v1.1 for GNOME shell
...
var preventZero = true; //prevent from running on 0 delay.
...
function init() {
    ...
    Gettext.bindtextdomain("shutdown-timer", user_locale_path);
    Gettext.textdomain("shutdown-timer");
